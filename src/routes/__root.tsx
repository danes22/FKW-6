...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Website resmi FKW 6: kegiatan, desain baju, dan galeri." },
      { name: "author", content: "FKW 6" },
      { property: "og:title", content: "FKW 6 — Official Website" },
      { property: "og:description", content: "Kegiatan, desain baju & galeri FKW 6." },
